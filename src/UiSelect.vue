            ...
            >
                ...
                <div class="ui-select__display">
                    ...
                    <ui-icon v-show="showClearIcon" class="ui-select__clear-button">
                        <svg @click="clear()" v-show="showClearIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22" width="16" height="16">
                            <path d="M9.1,7.9l6.7-6.7c0.3-0.3,0.3-0.7,0-1s-0.7-0.3-1,0L8.1,6.9L1.3,0.2c-0.3-0.3-0.7-0.3-1,0s-0.3,0.7,0,1l6.7,6.7l-6.7,6.7
	c-0.3,0.3-0.3,0.7,0,1c0.1,0.1,0.3,0.2,0.5,0.2s0.3-0.1,0.5-0.2l6.7-6.7l6.7,6.7c0.1,0.1,0.3,0.2,0.5,0.2c0.2,0,0.3-0.1,0.5-0.2
	c0.3-0.3,0.3-0.7,0-1L9.1,7.9z"/>
                        </svg>

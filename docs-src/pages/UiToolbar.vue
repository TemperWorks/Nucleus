<template>
    <section class="page page--ui-toolbar">
        ...
        <p>UiToolbar has three types: <code>default</code>, <code>colored</code> and <code>clear</code>. The toolbar can be raised (with a drop shadow) and the navigation icon, brand, title and actions can be customized using slots.
        </p>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                The type of toolbar (determines the background color). One of <code>default</code>, <code>colored</code>
                                or <code>clear</code>.
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>The toolbar navigation icon. Can be any of the <a
                                    href="https://design.google.com/icons/" target="_blank" rel="noopener">Material Icons</a>.
                                </p>
                        ...
                        <tr>
                            ...
                            <td>Whether or not the navigation icon is removed. Set to <code>true</code>
                        ...
                        <tr>
                            ...
                            <td>Whether or not the toolbar has a drop shadow. Set to <code>false</code>
                        ...
                        <tr>
                            ...
                            <td>The position of the progress bar relative to the toolbar. One of <code>top</code>
                                or <code>bottom</code>.</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>Boolean</td>
                            <td><code>false</code></td>
                            <td>Whether or not the progress is shown. Set to <code>true</code> to show the progress.
                            </td>
                        </tr>
                        </tbody>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <p>
                                    Holds the toolbar navigation icon and can contain any custom or SVG icon or icon button.</p>
                            </td>
                        </tr>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                Emitted when the navigation icon is clicked. Listen for it using <code>@nav-icon-click</code>.
                            </td>
                        </tr>
                        </tbody>
                    </table>

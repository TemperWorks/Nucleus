<template>
    <section class="page page--ui-checckbox">
        ...
        <h3 class="page__section-title">
            Examples <a href="https://github.com/TemperWorks/Nucleus/blob/master/docs-src/components/ui-checkbox/UiCheckboxDocs.vue" target="_blank" rel="noopener">View Source</a>
        </h3>
